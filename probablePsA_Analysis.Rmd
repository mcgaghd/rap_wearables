...
```{r}
dat$Cad30 <- dat$CadencePeak30Adjusted.steps.min.
dat$Cad1 <- dat$CadencePeak1Adjusted.steps.min.
```

```{r}
sd(dat$Cad30) #3822.266
# Generate a standardization variable
dat$Cad30_std = (dat$Cad30) - mean(dat$Cad30)/sd(dat$Cad30)
# Check distribution of variable
hist(dat$Cad30_std)
```

```{r}
sd(dat$Cad1) #3822.266
# Generate a standardization variable
dat$Cad1_std = (dat$Cad1) - mean(dat$Cad1)/sd(dat$Cad1)
# Check distribution of variable
hist(dat$Cad1_std)
```
...
```{r}
exposures <- c("step_thirds", "step_quintiles","cadence30_thirds","cadence30_quintiles", "cadence1_thirds", "cadence1_quintiles")
...
Sequential adjustment plots ###Sequential model adjustment Next we perform sequential adjustment.
...
Interaction term with prodromal Subgroup analysis using Harry's method
