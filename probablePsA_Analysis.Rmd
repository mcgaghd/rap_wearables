...
dat <- fread("PsAfinal/prepped_steps_PsA_symptoms.csv", data.table = FALSE)
...
```{r}
pain <- fread("participant_data_pain.csv", data.table = FALSE)

# Step 2: Join filtered_dat with dat_GPlist to include the data_provider information
dat_pain <- dat %>%
  left_join(pain %>% select(eid, pain_last_month,pain_3month_Knee,pain_3month_Hip, pain_3month_Back, pain_3month_NeckShoulder, pain_3month_General), by = "eid")
...
dat$pain_1year <- (dat$HipPain_1year | dat$KneePain_1year | dat$BackPain_1year | dat$WristHandPain_1year | dat$FingerPain_1year |dat$swelling_1year)
#use these two and arthralgia
dat$FatigueMyalgia_1year <- (dat$myalgia_1year|dat$fatigue_1year)

dat$pain_5years <- (dat$HipPain_5years | dat$KneePain_5years | dat$BackPain_5years| dat$FingerPain_5years|dat$WristHandPain_5years |dat$swelling_5years)

dat$pain_2years <- (dat$HipPain_2year | dat$KneePain_2year | dat$BackPain_2year | dat$WristHandPain_2year | dat$FingerPain_2year)
#use these two and arthralgia
