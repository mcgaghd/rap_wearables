...
dat$total_6months <- (dat$HipPain_6months | dat$KneePain_6months | dat$BackPain_6months |dat$swelling_6months |dat$arthralgia_6months|dat$Bursitis_6months|dat$tendonitis_6months|dat$fatigue_6months|dat$myalgia_6months|dat$Stiffness_6months|dat$FingerPain_6months|dat$WristHandPain_6months)

dat$total_1year <- (dat$HipPain_1year | dat$KneePain_1year | dat$BackPain_1year |dat$swelling_1year|dat$arthralgia_1year|dat$Bursitis_1year|dat$tendonitis_1year|dat$fatigue_1year|dat$myalgia_1year|dat$Stiffness_1year|dat$FingerPain_1year|dat$WristHandPain_1year)

dat$total_2year <- (dat$HipPain_2year | dat$KneePain_2year | dat$BackPain_2year |dat$swelling_2year|dat$arthralgia_2year|dat$Bursitis_2year|dat$tendonitis_2year|dat$fatigue_2year|dat$myalgia_2year|dat$Stiffness_2year|dat$FingerPain_2year|dat$WristHandPain_2year)
...
dat$pain_2years <- (dat$HipPain_2year | dat$KneePain_2year | dat$BackPain_2year |dat$swelling_2year|dat$arthralgia_2year)

dat$JointPainChronic <- (dat$HipPain_5year | dat$KneePain_5year | dat$BackPain_5year| dat$pain_3month_Back|dat$pain_3month_Hip|dat$pain_3month_General|dat$pain_3month_Knee)
...
Full <- coxph((Surv(age_entry_days, age_exit_days_2, ProbDefPsA_incident)) ~ 
                           (med_steps_std)+as.factor(MET_tertiles_local)  +as.factor(sex) +as.factor(tdi_quarters)+as.factor(qualif) + as.factor(smoking) +as.factor(alcohol),
                          data=dat)
...
symptoms <- coxph((Surv(age_entry_days, age_exit_days_2, ProbDefPsA_incident)) ~ 
                           (cadence30_thirds)*(JointPainChronic)+as.factor(sex) +as.factor(tdi_quarters)+as.factor(qualif) + as.factor(smoking) +as.factor(alcohol),
                          data=dat)
...
Full_withSymptoms <- coxph((Surv(age_entry_days, age_exit_days_2, ProbDefPsA_incident)) ~ 
                           (CadencePeak30Adjusted.steps.min.)*total_2year +as.factor(sex) +as.factor(tdi_quarters)+as.factor(qualif) + as.factor(smoking) +as.factor(alcohol),
                          data=dat)
...
datPsO <- datPsO %>%
  mutate(NonSymptoms = !(total_2year))
...
```{r}
model_steps1 <- lm(med_steps ~ ChronicMSKpain + as.factor(sex)+ as.factor(season_wear)+ as.factor(tdi_cats),  data = datPsO)
