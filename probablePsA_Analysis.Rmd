...
data <- data.frame(
  ...
  HR_per_1000_step_increase = c(0.9079, 0.9173, 0.9575),
  CI_lower = c(0.8560, 0.8589, 0.8870),
  CI_upper = c(0.9628, 0.9797, 1.034),
  Cases_n = c("99 / 2597", "77 / 2575", "52 / 2550")
)
...
forest_plot <- ggplot(data, aes(x = HR_per_1000_step_increase, y = Model, xmin = CI_lower, xmax = CI_upper)) +
  ...
  scale_x_continuous(breaks = c(0.4,0.5,0.6, 0.7, 0.8, 0.9, 1.0, 1.1, 1.2, 1.3), limits = c(0.4, 1.3), trans = "log") +
  theme_classic() +
  theme(
