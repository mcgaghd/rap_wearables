...
```{r}
model_steps1 <- lm(med_steps ~ OralSteroids + as.factor(sex)  + as.factor(age_gp) + as.factor(season_wear)+ as.factor(tdi_cats) + as.factor(alcohol) + as.factor(smoking),  data = GP_steroids_PsA)
summary(model_steps1)
  confint(model_steps1)
  
emmeans_model_steps1_np<- emmeans(model_steps1, specs = "OralSteroids")
emmeans_model_steps1 <- emmeans(model_steps1, specs = pairwise~ OralSteroids)
...
```{r}
model_steps1 <- lm(med_steps ~ OralSteroids + as.factor(sex)  + as.factor(age_gp) + as.factor(season_wear)+ as.factor(tdi_cats) + as.factor(alcohol) + as.factor(smoking),  data = GP_steroids_RA)
summary(model_steps1)
  confint(model_steps1)
...
```{r}
model_steps1 <- lm(med_steps ~ PersistentOpioid + as.factor(sex)  + as.factor(age_gp) + as.factor(season_wear)+ as.factor(tdi_cats) + as.factor(alcohol) + as.factor(smoking),  data = GP_opioids_RA)
summary(model_steps1)
  confint(model_steps1)
  
emmeans_model_steps1_np<- emmeans(model_steps1, specs = "PersistentOpioid")
emmeans_model_steps1 <- emmeans(model_steps1, specs = pairwise~ PersistentOpioid)
summary(emmeans_model_steps1_np)
summary(emmeans_model_steps1)
confint(emmeans_model_steps1)
