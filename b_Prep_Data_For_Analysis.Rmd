...
cols_dat <- c("eid", "sex", "year_birth", "month_birth", "ethnicity_raw",
              ...
              "PRS_RA", "RheumFactor_baseline","RheumFactor_status", "fresh_fruit_intake", "processed_meat_intake","oily_fish_intake","slt_added_to_food",
...
sum(datRF$total_prevalent_RA)  ## 313 with positive RF and RA 
#Need to remove these individuals 
datRF <- datRF %>% filter(!total_prevalent_RA)

sum(datRF$RA_incident) # 60 people developed RA in the RF positive group 
