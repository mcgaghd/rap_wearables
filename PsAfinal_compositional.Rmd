...
all_only_fu <-  all_only_fu[all_only_fu$age_entry_days < all_only_fu$age_exit_days, ]

# Recode relevant time points
all_only_fu$agein <- all_only_fu$age_entry_days
all_only_fu$ageout <- all_only_fu$age_exit_days
...
only_fu_model <-
  comp_model(
    ...
    event = all_only_fu$PsATotal_incident),
    data = all_only_fu,
    comp_labels = comp_labels,
    rounded_zeroes = TRUE,
...
all_only_fu_4yr <-  all_only_fu_4yr[all_only_fu_4yr$age_entry_days < all_only_fu_4yr$age_exit_days, ]

# Recode relevant time points
all_only_fu_4yr$agein <- all_only_fu_4yr$age_entry_days
all_only_fu_4yr$ageout <- all_only_fu_4yr$age_exit_days
...
only_fu_4yr_model <-
  comp_model(
    ...
    event = all_only_fu_4yr$PsATotal_incident),
...
svg("forestplot_main_halfhour.svg")
...
#### Main plot (run all at once to get to print)
forestplot_only_fu <- forest_plot_comp(
  composition_list = list_for_plot,
  model = only_fu_model,
  comp_labels = comp_labels,
  pred_name = "Hazard Ratio (95% CI)",
...
#### Main plot
forestplot_main_halfhour_only_fu <-forest_plot_comp(composition_list=list_for_plot_halfhour,
                 model = only_fu_model, 
                 comp_labels = comp_labels,
                 pred_name = "Hazard Ratio (95% CI)",
  text_settings = forestplot::fpTxtGp(
  ...
  boxsize = 0.2,
  x_label = "Estimated Hazard Ratio")
forestplot_main_halfhour_only_fu

svg("forestplot_main_halfhour_only_fu.svg")
...
#### Main plot (run all at once to get to print)
forestplot_only_fu_4yr <- forest_plot_comp(
  composition_list = list_for_plot,
  model = only_fu_4yr_model,
  comp_labels = comp_labels,
  pred_name = "Hazard Ratio (95% CI)",
  text_settings = forestplot::fpTxtGp(
    label = grid::gpar(
...
#### Main plot
forestplot_main_halfhour_only_fu_4yr <-forest_plot_comp(composition_list=list_for_plot_halfhour,
                 model = only_fu_4yr_model, 
                 comp_labels = comp_labels,
                 pred_name = "Hazard Ratio (95% CI)",
  text_settings = forestplot::fpTxtGp(
  ...
  boxsize = 0.2,
  x_label = "Estimated Hazard Ratio")
forestplot_main_halfhour_only_fu_4yr
