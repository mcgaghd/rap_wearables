...
Add in pain indicators 
Join up with baseline pain 
...
Updated version of steps with 95th centile of cadence 
```{bash}
cd ~/rap_wearables
...
Indicator if GP data 
Exclude those without GP data 
```{r}
