...
Symptoms indicator
```{r}
datArthralgia_gp <-fread("PrimaryCareClean/datArthralgia_gp.csv", data.table = FALSE) # fread is a function from the data.table package for fast reading of large data
datBackPain_gp <- fread("PrimaryCareClean/datBackPain_gp.csv", data.table = FALSE)
datBursitis_gp <- fread("PrimaryCareClean/datBursitis_gp.csv", data.table = FALSE)
datFatigue_gp <- fread("PrimaryCareClean/datFatigue_gp.csv", data.table = FALSE)
datFingerPain_gp <-fread("PrimaryCareClean/datFingerPain_gp.csv", data.table = FALSE) # fread is a function from the data.table package for fast reading of large data
datHipPain_gp <- fread("PrimaryCareClean/datHipPain_gp.csv", data.table = FALSE)
datKneePain_gp <- fread("PrimaryCareClean/datKneePain_gp.csv", data.table = FALSE)
datMyalgia_gp <- fread("PrimaryCareClean/datMyalgia_gp.csv", data.table = FALSE)
datStiffneess_gp <- fread("PrimaryCareClean/datStiffness_gp.csv", data.table = FALSE)
datSwelling_gp <- fread("PrimaryCareClean/datSwelling_gp.csv", data.table = FALSE)
