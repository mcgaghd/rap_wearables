...
"model5" = c("sex", "BMI_cats", multivar_covs, "PRS_RA_RiskGroup"),
"model6" = c("sex", "BMI_cats", multivar_covs,"PRS_RA_RiskGroup", "age_gp_crude"), # this is just a crude check that adjustment for age using age as timescale has worked
"model7" = c("sex", multivar_covs)
"model8" = c("sex", multivar_covs, "PRS_RA_RiskGroup")
)
