...
```{r}
# The lists of ICD codes we will consider
CVD_icd10_codes <- "^I(2[0-5]|6[0-9]).*"
CVD_icd9_codes <- "^(410|410\\.0|410\\.1|410\\.2|410\\.3|410\\.4|410\\.5|410\\.6|410\\.7|410\\.8|410\\.9|411|411\\.0|411\\.1|411\\.8|412\\.X|430\\.X|431\\.X|434\\.X|434\\.0|434\\.1|434\\.9|436\\.X1)$"
...
dat$CVD_incident <- dat$hes_incident_CVD & (!dat$total_prevalent_CVD)
...
dat$CVD_incident_date[!dat$incident_CVD] <- NA
