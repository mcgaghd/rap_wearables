...
dir.create("plots")
output_dir <- "plots"
output_file <- file.path(output_dir, "FullyAdjusted.tiff")
ggsave(output_file, shapeplot_RA_incident_step_quarters_1_ethnicity_tdi_quarters_qualif_season_wear_smoking_alcohol_red_processed_total_fruit_veg_total, device = "tiff", width = 6, height = 8, dpi = 300)
```
