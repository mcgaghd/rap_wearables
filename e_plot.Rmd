...
step_ref <-  mean(dat$med_steps[dat$med_steps < quarter1]) #5893.459 use mean steps in lowest category so match 
...
# CYCLE OVER ADJUSTMENTS=========================================
 for (adjustment in adjustments) {
  ...
  xlims <- c(0, quantile(dat$CadencePeak30.steps.min., 0.99))
