...
dir.create("plots")
output_dir <- "plots"
output_file <- file.path(output_dir, "FullyAdjusted4yr.tiff")
ggsave(output_file, shapeplot_RA_incident_step_quarters_sex_ethnicity_qualif_season_wear_smoking_alcohol_processed_meat_fresh_fruit_oily_fish, device = "tiff", width = 6, height = 8, dpi = 300)
```
...
```{r}
output_dir <- "plots"
output_file <- file.path(output_dir, "FullyAdjustedSpline4yr.tiff")
