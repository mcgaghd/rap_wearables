...
xbreaks <- c(0.3,0.5, 0.75, 1, 1.5,2,5)  # Include 2 in the breaks
xlim_scale <- 1
...
forest_plot <- forest_plot + 
  geom_text(aes(y = model, x = 2.8, label = paste0(HR_Text)), 
            hjust = -0.2, vjust = 0, size = 3.7, color = "black") +
  geom_text(aes(y = model, x = 2.0, label = paste0(events)),
            hjust = -0.2, vjust = 0, size = 3.7, color = "black")+
  geom_text(aes(y = model, x = 0.4, label = paste0(model)),
            hjust = 0, vjust = 0, size = 3.7, color = "black")
   geom_text(aes(y=group, x=3.0, label = paste0(heterogeneity)),
             hjust = 0, vjust = 0, size =3.7, color="black", parse = TRUE,check_overlap = TRUE)
