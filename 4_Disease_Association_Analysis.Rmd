...
label(dat$congestive_heart_failure_charlson) <- "Congestive heart failure"
label(dat$diabetes_charlson.y) <- "Diabetes"
label(dat$depression) <- "Depression"


tab_descComorbid <- table1::table1(~ cci + major_coronary_disease_charlson + congestive_heart_failure_charlson + diabetes_charlson.y + depression  | groups, 
                           data = dat 
                          #  ,render.cont = my_render_cont
)
tab_descComorbid
