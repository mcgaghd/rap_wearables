...
#Set up a corresponding label to these categories 
labels3 <- c("HC", "PsO + no opioid", "PsO + persistent opioid", "PsA + no opioid", "PsO + persistent opioid")
...
#Set up a corresponding label to these categories 
labels3 <- c("HC", "PsA + steroids", "PsA + no steroids", "PsO + steroids", "PsO + no steroids")
