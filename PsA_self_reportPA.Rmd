...
label(dat$MET_quartiles) <- "Quartiles of MET activity"
...
# Make table
tab_desc <- table1::table1(~ age_entry_years + sex + ethnicity + tdi_quarters  + smoking + alcohol + BMI + BMI_cats, 
